...
export default function VideoScreen({ navigation }) {
    ...
    return (
        < View style={styles.container} >
            ...
            {
                Platform.OS == 'ios' ?
                    <View style={{ justifyContent: 'flex-end', position: "absolute", right: 0, bottom: 0, padding: 20 }}  >
                        <TouchableOpacity
                            onPress={() => setSelect(true)}
                            style={{ height: 50, width: 50, backgroundColor: "orange", borderRadius: 25, alignItems: "center", justifyContent: 'center' }}
                        >
                            <Text>Add</Text>
                        </TouchableOpacity>
                    </View>
